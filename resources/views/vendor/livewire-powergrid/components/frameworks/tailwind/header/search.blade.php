        ...
        <div class="relative rounded-full w-full md:w-4/12 float-end float-right md:w-full lg:w-1/2">
              <span class="absolute inset-y-0 left-0 flex items-center pl-1">
                 <span class="p-1 focus:outline-none focus:shadow-outline">
                    <x-livewire-powergrid::icons.search class="text-purple-600"/>
                 </span>
              </span>
            <input wire:model.debounce.600ms="search" type="text"
                   style="padding-left: 36px !important;"
                   class="placeholder-slate-400 block w-full float-right bg-black text-slate-700 border border-slate-300 rounded-full py-2 px-3 leading-tight focus:outline-none focus:bg-slate-300 focus:border-slate-500 pl-10 dark:bg-slate-600 text-purple-600 placeholder-slate-200 border-slate-500"
