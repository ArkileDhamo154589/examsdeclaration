<div class="items-center justify-between sm:flex">
    <div class="items-center justify-between w-full sm:flex-1 sm:flex">
        @if($recordCount === 'full')
            <div>
                <div class="mr-2 leading-5 text-center text-slate-700 text-md t sm:text-right">
        ...
        @elseif($recordCount === 'short')
            <div>
                <p class="mr-2 leading-5 text-center text-slate-700 text-md text-purple-600">
                    <span class="font-semibold firstItem"> {{ $paginator->firstItem() }}</span>
                    -
                    <span class="font-semibold lastItem"> {{ $paginator->lastItem() }}</span>
                    |
        ...
        @elseif($recordCount === 'min')
            <div>
                <p class=" mr-2 leading-5 text-center text-slate-700 text-md text-slate-300">
                    <span class="font-semibold firstItem"> {{ $paginator->firstItem() }}</span>
                    -
                    <span class="font-semibold lastItem"> {{ $paginator->lastItem() }}</span>
                </p>
            ...
            <nav role="navigation" aria-label="Pagination Navigation" class="items-center justify-between sm:flex">
                <div class="flex justify-center mt-2 md:flex-none md:justify-end sm:mt-0">
                    ...
                    @if ($paginator->hasMorePages())
                        ...
                        @endif
                        <a class="px-2 py-1 pt-2 m-1 text-center text-white bg-purple-500 border-slate-400 rounded cursor-pointer border-1 hover:bg-slate-600 hover:border-slate-800 dark:text-slate-300"
